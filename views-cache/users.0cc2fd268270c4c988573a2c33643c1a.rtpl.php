...
<div class="content-wrapper">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/ecommerce/admin/users/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i
                        class="fa fa-edit"></i> Editar</a>
                    <a href="/ecommerce/admin/users/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/delete"
  ...
  <noscript>
    <p>O Javascript está desabilitado. Algumas funções do site podem não funcionar corretamente</p>
  </noscript>
  <!-- /.content -->
</div>
<!-- /.content-wrapper -->