        ...
        <form role="form" action="/ecommerce/admin/products/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="vlweight" name="vlweight" placeholder="0.00">
            </div>
            <div class="form-group">
              <label for="vlweight">Url</label>
              <input type="text" class="form-control" id="vlweight" name="desurl" placeholder="example.url">
            </div>
          </div>
          <!-- /.box-body -->
