            ...
            <div class="col-md-3 col-sm-6">
                <div class="single-shop-product">
                    ...
                    <div class="product-option-shop">
                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="70" rel="nofollow" href="/ecommerce/canvas/shop/?add-to-cart=70">Comprar</a>
                    </div>                       
                </div>
            </div>
            <?php } ?>
            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars( $linkprev, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Previous">
                        ...
                        <li>
                            <a href="<?php echo htmlspecialchars( $linknext, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Next">
                            <span aria-hidden="true">»</span>
                            </a>
                        </li>
                        <?php }else{ ?>
